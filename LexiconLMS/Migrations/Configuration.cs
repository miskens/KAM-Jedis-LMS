    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LexiconLMS.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(LexiconLMS.Models.ApplicationDbContext context)
        {
         ...
         context.Groups.AddOrUpdate(g => g.Name,
            ...
            new Group { Name = "Sharepoint", Description = "Sharepoint förr och nu. Den här klassen kommer att handla om att sitta och nöta arslet och klicka på framåt- och bakåtknapparna i browsern, samt att klicka i textrutor och ange siffror mellan 1-10. Det kan även hända att man får klicka på en färg för att sätta bakgrundsfärgen på en sida.", StartDate = new DateTime(2016, 02, 01), EndDate = new DateTime(2016, 04, 10) },
            ...
            //new Group { Name = "EMACS", Description = "En editor och ett fönstersystem och ett enprocessoperativsystem, allt i ett!", StartDate = new DateTime(2015, 01, 01), EndDate = new DateTime(2015, 04, 30) },
            ...
            context.Courses.AddOrUpdate(c => c.Name,
                ...
                new Course { Name = "C# Överkurs", Description = shortLorem, StartDate = new DateTime(2015, 10, 01), EndDate = new DateTime(2016, 02, 28), GroupId = 1 },
                ...
                //new Course { Name = "Sharepoint newbie", Description = "Färskingar!", StartDate = new DateTime(2016, 02, 01), EndDate = new DateTime(2016, 02, 02), GroupId = 6 },
                //new Course { Name = "Sharepoint mellannivå", Description = "Inte nybörjare, inte expert?", StartDate = new DateTime(2016, 02, 03), EndDate = new DateTime(2016, 03, 04), GroupId = 6 },
                //new Course { Name = "Sharepoint expert", Description = "Sharepoint för experter, övriga göre sig ej besvär!", StartDate = new DateTime(2016, 02, 01), EndDate = new DateTime(2016, 02, 02), GroupId = 6 },
                //new Course { Name = "Avslutningsfika", Description = "Sharepoint för experter, övriga göre sig ej besvär!", StartDate = new DateTime(2016, 02, 07), EndDate = new DateTime(2016, 02, 09), GroupId = 6 },
            ...
            context.Activities.AddOrUpdate(a => a.Name,
                ...
                new Activity { Name = "C# för den allvetande", Description = shortLorem, Type = "inlämningsuppgift", StartDate = new DateTime(2015, 12, 15), EndDate = new DateTime(2016, 02, 28), CourseId = 6 },
            ...
            context.Documents.AddOrUpdate(d => d.Name,
                new Document { Name = "Tillagt gruppdokument", Uri = "gruppdokument.txt", Description = "Testdokument för att testa kopplat till grupp. Helt klart ett test. Ett test är det. Nån som vill ha kaffe?", UploadTime = new DateTime(2015, 09, 30), GroupId = 1, UserId = context.Users.Where(u => u.FullName == "Oscar Jakosbsson").FirstOrDefault().Id, OriginalFileName = "gruppdokument.txt" },
                new Document { Name = "gruppinformation", Uri = "studentinformation.txt", Description = "Teleofnnummer till folk", UploadTime = new DateTime(2015, 09, 30), GroupId = 1, UserId = context.Users.Where(u => u.FullName == "Oscar Jakosbsson").FirstOrDefault().Id, OriginalFileName = "studentinformation.txt" },
                ...
                new Document { Name = "Tillagt aktivitetsdokument", Uri = "aktivitetsdokument.txt", Description = longLorem, UploadTime = new DateTime(2015, 10, 05), ActivityId = 1, UserId = context.Users.Where(u => u.FullName == "Oscar Jakosbsson").FirstOrDefault().Id, OriginalFileName = "aktivitetsdokument.txt" },
                new Document { Name = "Tillagt aktivitetsdokument nummer 2", Uri = "aktivitetsdokument2.txt", Description = longLorem, UploadTime = new DateTime(2015, 10, 05), ActivityId = 2, UserId = context.Users.Where(u => u.FullName == "Oscar Jakosbsson").FirstOrDefault().Id, OriginalFileName = "aktivitetsdokument2.txt" },
