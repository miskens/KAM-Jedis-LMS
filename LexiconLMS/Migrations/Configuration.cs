        ...
        protected override void Seed(LexiconLMS.Models.ApplicationDbContext context)
        {
         ...
         context.Groups.AddOrUpdate(g => g.Name,
            ...
            context.Activities.AddOrUpdate(a => a.Name,
                ...
                new Activity { Name = "C# för den allvetande", Description = "Det allvetande programmet regerar", Type = "E-Learning", StartDate = new DateTime(2015, 10, 01), EndDate = new DateTime(2015, 11, 01), CourseId = 6 },
                ...
                new Activity { Name = "C# för den allvetande", Description = shortLorem, Type = "E-Learning", StartDate = new DateTime(2015, 12, 15), EndDate = new DateTime(2016, 02, 28), CourseId = 6 },
            ...
            context.Documents.AddOrUpdate(d => d.Name,
                new Document { Name = "Tillagt gruppdokument", Uri = "gruppdokument.txt", Description = "Testdokument för att testa kopplat till grupp. Helt klart ett test. Ett test är det. Nån som vill ha kaffe?", UploadTime = new DateTime(2015, 09, 30), GroupId = 2, UserId = context.Users.Where(u => u.FullName == "Oscar Jakobsson").FirstOrDefault().Id, OriginalFileName = "gruppdokument.txt" }
